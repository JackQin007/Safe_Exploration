...
with open('/home/nuc001/code/safety-gymnasium/safety-gymnasium-main/safety_gymnasium/tasks/safe_isaac_gym/envs/cfgs/freight_franka_pick_and_place.yaml', 'r') as yaml_file:
...
if __name__ == '__main__':
    env = FreightFrankaPickAndPlace( cfg = data)
